...
class Pokemon_Data:
    def __init__(self,species: str,number: int,types: list[str],gender_ratio:float,abilities:list[str],moveset:dict[int,str],base_stats:list[int],entry:str):
        ...
        self.number=number #pokedex number, determined by index of child class in Pokedex.DEX
        ...
        self.moveset=moveset #dictionary matching move strings to level they are learned at, change to Move objects when they are made
...
class Bulbasaur_Data(Pokemon_Data):
    def __init__(self):
        Pokemon_Data.__init__(self,'Bulbasaur',1,['grass','poison'],0.875,['Ability 1','Ability 2', 'ha_Ability 3'],{'Tackle':1,'Vine Whip':6},[1,2,3,4,5,6],'This is Bulbasaur')

class Charmander_Data(Pokemon_Data):
    def __init__(self):
        Pokemon_Data.__init__(self,'Bulbasaur',2,['fire',None],0.875,['Ability 4','Ability 5', 'ha_Ability 6'],{'Tackle':1,'Ember':6},[1,2,3,4,5,6],'This is Charmander')

class Squirtle_Data(Pokemon_Data):
    def __init__(self):
        Pokemon_Data.__init__(self,'Bulbasaur',3,['water',None],0.875,['Ability 7','Ability 8', 'ha_Ability 9'],{'Tackle':1,'Bubble Beam':6},[1,2,3,4,5,6],'This is Squirtle')


#contains static attribute DEX, dictionary matching species strings to respective pokemon_data child class
class Pokedex:
    DEX={'Bulbasaur':Bulbasaur_Data(),
