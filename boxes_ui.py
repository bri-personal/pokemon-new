...
class BoxesUI:
    ...
    def __init__(self,game):
        ...
        img.fill(WHITE)
        draw_text(img,"Box "+str(self.page_index),BoxesUI.BOX_BUTTON_SIZE//3,BLACK,(BoxesUI.BOX_BUTTON_SIZE+BoxesUI.BORDER_BTW_BUTTONS)*3//2,BoxesUI.BOX_BUTTON_SIZE//4,'center')
